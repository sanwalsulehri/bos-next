...
const HeroHome = () => {
  return (
    <div className='py-14 max-w-[1200px] text-[#161721] mx-auto flex flex-col items-center gap-4'>
       <div className='max-w-[840px] mx-auto'>
        ...
        <p className='text-[#4A4C56] text-center md:text-[18px] font-[400] '>It’s the fastest  and easy way to exlerate your business, without any hassle. Mange<br /> your micro and macro team from anywhere in the world</p>
